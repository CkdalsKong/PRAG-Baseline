...
class TreeBuilder:
    ...
    def build_from_text(self, text: str, use_multithreading: bool = True) -> Tree:
        ...
        if use_multithreading:
            print("🔄 Creating leaf nodes with multithreading...")
            leaf_nodes = self.multithreaded_create_leaf_nodes(chunks)
        else:
            print("🔄 Creating leaf nodes sequentially...")
            leaf_nodes = {}
            for index, text in tqdm(enumerate(chunks), total=len(chunks), desc="Creating leaf nodes"):
        ...
        print("🔄 Constructing tree layers...")
